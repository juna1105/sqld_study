const quizData = [
  {
    id: 1,
    question: "엔티티는 데이터베이스에서 관리되는 객체 또는 개념을 의미한다.",
    correctAnswer: "O",
    explanation:
      "엔티티는 업무에서 관리되는 데이터 집합으로, 저장되고 관리되어야 하는 데이터의 최소 단위입니다.",
    category: "엔티티",
  },
  {
    id: 2,
  ...
  },
  {
    id: 11,
    question:
      "식별자는 하나의 엔티티 내에서 인스턴스를 구분할 수 있는 구분자이다.",
    correctAnswer: "O",
    explanation:
      "식별자는 엔티티 내에서 각각의 인스턴스를 유일하게 구분할 수 있는 속성 또는 속성의 조합입니다.",
    category: "식별자",
  },
  {
    id: 12,
    question:
      "관계형 데이터베이스에서 관계(Relationship)는 엔티티 간의 업무적 연관성을 의미한다.",
    correctAnswer: "O",
    explanation:
      "관계는 두 개 이상의 엔티티 간에 존재하는 업무적 연관성을 의미하며, 이를 통해 데이터 간의 논리적 연결을 표현합니다.",
    category: "관계",
  },
  {
    id: 13,
    question:
      "데이터 모델링에서 1:N 관계는 한 엔티티의 하나의 인스턴스가 다른 엔티티의 여러 인스턴스와 관계를 맺는 것을 의미한다.",
    correctAnswer: "O",
    explanation:
      "1:N 관계는 하나의 부모 엔티티 인스턴스가 여러 개의 자식 엔티티 인스턴스와 관계를 맺는 것을 의미합니다.",
    category: "관계",
  },
  {
    id: 14,
