...
export const exam2 = [
  ...
  },
  {
    ...
    options: [
      "한 엔티티 인스턴스가 다른 엔티티 인스턴스와 연결될 수 있는/필요한 수량 관계",
      "관계에 참여하는 엔티티의 총 수",
      "속성이 테이블에 저장되는 방식",
      "테이블의 물리적 저장 크기",
    ],
    answer: 0,
    해설: "카디널리티는 엔티티 간의 수적 관계를 나타내며, 1:1(일대일), 1:N(일대다), M:N(다대다) 등의 유형이 있습니다. 예를 들어 '한 학생은 여러 강의를 수강할 수 있고, 한 강의는 여러 학생이 수강할 수 있다'는 M:N 관계입니다.",
  },
  {
    question:
  ...
  },
  {
    ...
    options: [
      "단일 엔티티 인스턴스에 대해 여러 값을 가질 수 있는 속성",
      "복합 속성(Composite Attribute)과 동일한 개념",
      "1NF를 만족시키기 위해 반드시 필요한 속성",
      "단 하나의 값만 가질 수 있는 속성",
    ],
    answer: 0,
    해설: "다중값 속성은 하나의 엔티티가 여러 값을 가질 수 있는 속성입니다. 예를 들어 한 사람이 여러 전화번호를 가질 수 있는 경우입니다. 이러한 속성은 일반적으로 별도의 테이블로 분리하거나 배열 타입으로 저장합니다.",
  },
  {
    question:
